$('#nombre_recurso').blur(function(){
    ...
    if (nombre_recurso.indexOf('') == -1) {
      	...
      	$('#nombre_recurso').html('Ingrese Nombre del Hospital');
    } else {
...
$("#registroHospital").click(function(){
	if($('#nombre_recurso').val() == "" 
        ...
        $('#span_mensaje_nombre_recurso').html('Ingrese el nombre del hospital');
        var animate_in = 'lightSpeedIn', animate_out = 'bounceOut';
        new PNotify({title: 'Alerta',text: 'Por favor! ingrese el nombre del hospital',
	             type: 'error',delay: 2500,
	             animate: {animate: true,in_class: animate_in,out_class: animate_out}
        });
