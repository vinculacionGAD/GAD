$('#nombre_recurso').blur(function(){
    ...
    if (nombre_recurso.indexOf('') == -1) {
      	...
      	$('#nombre_recurso').html('Ingrese Nombre de la Marina');
    } else {
...
$("#registroMarina").click(function(){
	if($('#nombre_recurso').val() == "" 
        ...
        new PNotify({title: 'Alerta',text: 'Por favor! ingrese el nombre de la Marina',
	             type: 'error',delay: 2500,
	             animate: {animate: true,in_class: animate_in,out_class: animate_out}
        });
        ...
        var animate_in = 'lightSpeedIn', animate_out = 'bounceOut';
        new PNotify({title: 'Alerta',text: 'Por favor! ingrese la dirección de la Marina',
                 type: 'error',delay: 2500,
                 animate: {animate: true,in_class: animate_in,out_class: animate_out}
        });
