<div class="container">
	...
	<div class="form-group">
		<div class="col-lg-12 col-md-12 col-xs-12">
			...
			{!!Form::text('detalle_enfermedad_cronica',null,['id'=>'detalle_enfermedad_cronica','class'=>'form-control', 'placeholder'=>'Ingresa un detalle de la enfemedad crónica'])!!}
		</div>
	</div>
	<div class="form-group">
		<div class="col-lg-12 col-md-12 col-xs-12">
	...
	<div class="form-group">
		<div class="col-lg-12 col-md-12 col-xs-12">
			...
			{!!Form::text('detalle_afectacion_desastre',null,['id'=>'detalle_afectacion_desastre','class'=>'form-control', 'placeholder'=>'Ingresa un detalle de la afectación del desastre'])!!}
		</div>
	</div>
	<div class="form-group">	
		<div class="col-lg-12 col-md-12 col-xs-12">
