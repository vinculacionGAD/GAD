<div class="container">
	...
	<div class="form-group">
		<div class="col-lg-12 col-md-12 col-xs-12">
			{!!Form::label('n_enfermeras','Número de enfermeras:')!!}
			{!!Form::text('n_enfermeras', null,['id'=>'n_enfermeras','class'=>'form-control', 'placeholder'=>'Ingresa el número de enfermeras'])!!}
		</div>
	</div>
	<div class="form-group">
		<div class="col-lg-12 col-md-12 col-xs-12">
			{!!Form::label('n_quirofanos','Número de quirófanos:')!!}
			{!!Form::text('n_quirofanos', null,['id'=>'n_quirofanos','class'=>'form-control', 'placeholder'=>'Ingresa el número de quirófanos'])!!}
		</div>
	</div>
	<div class="form-group">
		<div class="col-lg-12 col-md-12 col-xs-12">
