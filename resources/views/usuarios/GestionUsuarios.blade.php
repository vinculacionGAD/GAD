      ...
      <div class="x_title">
        <h2> Administración de Usuarios</h2>
          <ul class="nav navbar-right panel_toolbox">
            <li class="dropdown">
              <a href="#" id="modal" class="dropdown-toggle modal" data-toggle="modal" data-target="#myModal_IngresarUsuario"><i class="fa fa-user-plus fa-3x "></i></a>
            </li>
          </ul>
      ...
      <div class="modal-body">
        {!!Form::open(array('url'=>'','class'=>'frmActualizarUsuarios','method'=>'POST'))!!}
          <input  type="hidden" name="_token" value="{{ csrf_token() }}" id="token">
            ...
            {!!Form::label('Usuario:')!!}
            {!!Form::text('user_A',null,['id'=>'user_A', 'class'=>'form-control','placeholder'=>'Ingrese el nombre de Usuario','required'=>''])!!}

            {!!Form::label('Contrasena:')!!}
            {!!Form::password('password_A',['id'=>'password_A', 'class'=>'form-control','disabled'=>'true','placeholder'=>'Ingrese contrasena de Usuario','required'=>''])!!}
      </div>
...
<div class="modal fade" id="myModal_IngresarUsuario" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="myModalLabel">Ingresar Usuarios</h4>
      </div>
      <div class="modal-body">
